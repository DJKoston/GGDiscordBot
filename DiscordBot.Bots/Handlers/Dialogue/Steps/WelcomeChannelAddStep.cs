...
{
    public class welcomeChannelAddStep : DialogueStepBase
    {
        ...
        public override async Task<bool> ProcessStep(DiscordClient client, DiscordChannel channel, DiscordUser user)
        {
            ...
            {
                Title = $"Welcome Message Channel Creator",
                Description = $"{_content}",
                Color = DiscordColor.Blue,
            };

            respondEmbed.AddField("To cancel adding a Welcome Channel", "Use the !cancel command");
