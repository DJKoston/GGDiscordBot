...
{
    public class SetupChannelStep : DialogueStepBase
    {
        ...
        public override async Task<bool> ProcessStep(DiscordClient client, DiscordChannel channel, DiscordUser user)
        {
            ...
            while (true)
            {
                ...
                var ValidChannels = messageResult.Result.MentionedChannels;

                DiscordChannel ValidResult = null;

                foreach(DiscordChannel ValidChannel in ValidChannels)
                {
                    ValidResult = ValidChannel;
                }
